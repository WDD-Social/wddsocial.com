...
class VerificationEmail implements \Framework5\IView {
	...
	public function render($options = null) {
		return <<<HTML
			...
			<p>To do so, please <a href="http://wddsocial.com/verify/{$options['verificationCode']}" title="Verify your WDD Social Account">head over to WDD Social</a>, and you&rsquo;ll be all set!</p>
