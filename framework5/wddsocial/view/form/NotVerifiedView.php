...
class NotVerifiedView implements \Framework5\IView {		
	...
	*/
	...
	public function render($email = null) {
		...
		<p class="error"><strong><a href="/resend-verification" title="Resend Verification Email">Resend verification email</a></strong></p>
		<p class="error"><strong><a href="/change-fullsail-email" title="Change your Full Sail Email">Change your Full Sail email</a></strong></p>
